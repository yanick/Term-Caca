...
# This allows declaration	use Caca ':all';
...
sub AUTOLOAD {
    ...
    croak "&Caca::constant not defined" if $constname eq 'constant';
...
Caca - Perl extension for blah blah blah
...
Stub documentation for Caca, created by h2xs. It looks like the
...
Yanick Champoux, E<lt>yanick@babyl.dyndns.orgE<gt>

=head1 COPYRIGHT AND LICENSE

Copyright (C) 2011 by Yanick Champoux
